...
export default ({ user, ads, addToFavorites }: { user: IUser, ads: IAds, addToFavorites: (id: string) => void }) => {
	const handleAddToFavorites = () => {
		addToFavorites(ads.id);
	};

	const active = user.favorites_ids.indexOf(ads.id) != -1;
