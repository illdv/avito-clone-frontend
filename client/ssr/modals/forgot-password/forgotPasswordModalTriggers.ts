...
export const hideSendCodeToEmailModal          = () => store.dispatch(hide({name: ModalNames.sendCodeToEmail}));
...
export const hideForgotPasswordModal = () => store.dispatch(hide({name: ModalNames.forgotPassword}));
