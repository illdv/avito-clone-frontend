...
class ForgotPasswordModal extends React.Component {
    ...
    render() {
        return (<Modal name={ModalNames.forgotPassword} useOnRequestClose={true}>
                    ...
                    <div className="login-form">
                        <form action="#">
                            <div className="form-group row big-input">
                                ...
                                <input type="text" id="first-field" className="col-sm-6" name="first-field" required placeholder="Enter email or phone number" autoComplete="off"/>
                            </div>
...
//# sourceMappingURL=ForgotPasswordModal.jsx.map